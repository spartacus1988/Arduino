...
voltage_A1 = voltage_A1 * 2 - voltage_A0;
voltage_A2 = voltage_A2 * 3 - voltage_A1 - voltage_A0;
voltage_A3 = voltage_A3 * 4 - voltage_A2 - voltage_A1 - voltage_A0;
...
Serial.println(msg);
//Serial.println(str_voltage_A0);
//Serial.println(str_voltage_A1);
//Serial.println(str_voltage_A2);
//Serial.println(str_voltage_A3);
Serial.println("");
Serial.println("");
Serial.println("");
Serial.println("");
